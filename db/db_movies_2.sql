...
# Database: db_movies_2
# Generation Time: 2019-02-09 16:44:20 +0000
# ************************************************************
...
INSERT INTO `tbl_arating` (`arating_id`, `arating_name`, `arating_desc`)
VALUES
...
INSERT INTO `tbl_cast` (`cast_id`, `cast_name`)
VALUES
	(36,'Amy Adams'),
	(26,'Andrew Garfield'),
	(8,'Aneurin Barnard'),
...
INSERT INTO `tbl_director` (`director_id`, `director_name`)
VALUES
	(1,'James Gunn'),
	(2,'Christopher Nolan'),
	(3,'James Mangold'),
...
INSERT INTO `tbl_language` (`lang_id`, `lang_name`)
VALUES
	(1,'Abkhaz'),
	(2,'Afar'),
	(3,'Afrikaans'),
...
INSERT INTO `tbl_mov_cast` (`mov_cast_id`, `movies_id`, `cast_id`)
VALUES
	(1,1,1),
	(2,1,2),
	(3,1,3),
...
INSERT INTO `tbl_mov_country` (`mov_country_id`, `movies_id`, `country_id`)
VALUES
	(1,1,34),
	(2,1,134),
	(3,1,184),
...
# Dump of table tbl_mov_director
# ------------------------------------------------------------
...
INSERT INTO `tbl_mov_director` (`mov_director_id`, `movies_id`, `director_id`)
VALUES
	(1,1,1),
	(2,2,2),
	(3,3,3),
...
INSERT INTO `tbl_mov_genre` (`mov_genre_id`, `movies_id`, `genre_id`)
VALUES
	(1,1,1),
	(2,1,2),
	(3,1,9),
...
INSERT INTO `tbl_mov_lang` (`mov_lang_id`, `movies_id`, `language_id`)
VALUES
	(1,1,45),
	(2,2,45),
	(3,2,52),
...
INSERT INTO `tbl_mov_studio` (`mov_studio_id`, `movies_id`, `studio_id`)
VALUES
	(1,1,1),
	(2,2,2),
	(3,3,3),
...
INSERT INTO `tbl_movies` (`movies_id`, `movies_cover`, `movies_title`, `movies_year`, `movies_runtime`, `movies_storyline`, `movies_trailer`, `movies_release`)
VALUES
...
INSERT INTO `tbl_studio` (`studio_id`, `studio_name`)
VALUES
	(1,'Marvel Studios'),
	(2,'Syncopy'),
	(3,'Donners Company'),
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_ip`, `user_login_time`, `user_failed_login`, `user_failed_login_time`, `user_active`)
VALUES
	(1,'Daniela','Daniela Dantas','password','danidantas@test.com','2019-01-22 15:38:49','::1','2019-02-05 16:11:36',0,'2019-02-04 22:22:17',0),
	(2,'Justin','Justin','123','justin@test.com','2019-01-29 15:27:40','no','2019-02-01 12:59:50',NULL,NULL,NULL),
	(11,'dani','admin','$2y$10$NpN.M6Os9J1x114AZWpg/e1mZAVJlokoBw/cvuRfe6NvGHjsWlLR.','admin@test.com','2019-02-06 10:22:12','::1','2019-02-09 11:43:10',0,'2019-02-06 14:07:08',0),
	(12,'kid','kid','$2y$10$1L950WzPYEieGE5nVCA/TuqrKbYysDSqpzaB8M5.WrylVPn/mNXzO','dani@test.com','2019-02-06 12:13:18','no',NULL,0,NULL,0),
	(13,'older kid','older kid','$2y$10$TWUFu34J/UeaArpQ1odIBOOqdWaQ8K4vfckByoRYelNkf5A5EhpoS','dani@test.com','2019-02-06 12:13:51','no',NULL,0,NULL,0);
